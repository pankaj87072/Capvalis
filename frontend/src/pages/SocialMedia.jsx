...
const SocialMedia = () => {
  const socialPlatforms = [
    ...
    },
    {
      ...
      members: '0K',
      activity: '96%',
      description: 'Join our community for real-time market updates and more',
      link:'https://t.me/+m3vGDVPePR5mYWM9'
    },
    {
      name: 'Linked In',
      ...
      response: '90%',
      status: 'Online',
      description: '📈 Join our community for instant market insights and updates!',
  ...
  return (
    <div className="min-h-[60vh] w-full bg-black p-6">
      <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="h-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 
                ...
                <button className={`w-full py-3 px-4 rounded-lg font-medium transition-all duration-300
                                 ...
                                 hover:opacity-90 hover:shadow-lg`} onClick={()=>{window.open(platform.link,'_blank');}}>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-14 justify-center">
          <div className="bg-gray-800/30 rounded-xl p-6 text-center">
            <div className="text-2xl font-bold text-white mb-2">Monday to Friday | 10:00 AM to 6:00 PM</div>
